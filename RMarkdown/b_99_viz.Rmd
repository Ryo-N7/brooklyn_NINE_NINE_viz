...
rating_plot <- ep_rating_df %>% 
  ...
  geom_tile(aes(fill = value), size = 1.5,
            color = "black") +
  # scale_fill_gradient(low = "#c6dbef", high = "#0040FF", # low = "#E6FFFF", high = "#0040FF"
  #                      name = "Rating") +
  scale_fill_gradientn(colors = dichromat::colorschemes$LightBluetoDarkBlue.10) +
  ...
  theme(text = element_text(family = "Univers", color = "white"),
        ...
        axis.text = element_text(family = "Univers", color = "white", size = 12),
        legend.title = element_text(family = "Univers", color = "white"),
        legend.text = element_text(family = "Univers", color = "white"),
...
b99_ep_info_df <- readRDS("../data/brooklyn99_ep_info_df.RDS")
b99_ep_info_df %>% glimpse()
```
...
cols <- c("1" = "#FCF40E", "2" = "#3A3533", "3" = "#6CA9C3", "4" = "#0F0E0E", "5" = "#175E78")
# yellow: #FCF40E
# dark grey: #3A3533
# light teal: #6CA9C3
# black: #0F0E0E
...
viewer_plot <- viewers_df %>% 
  ...
  theme(text = element_text(family = "Univers", color = "#F9FEFF"),
        ...
        panel.background = element_rect(color = NA, fill = "#0053CD"),
        panel.grid = element_blank()) +
  annotate(geom = "label", x = 20, y = 17, label = "Aired after Super Bowl!")
