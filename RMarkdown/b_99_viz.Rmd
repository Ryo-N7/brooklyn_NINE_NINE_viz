...
theme_b99 <- function(){
  ...
  theme_minimal() %+replace%
    theme(text = element_text(family = "Univers", color = "#F9FEFF",
                              ...
                              lineheight = 0.9, margin = margin(0),
                              debug = FALSE),
...
viewers_df %>% 
  ggplot(aes(x = num_overall, y = viewers)) +
  geom_point() +
  labs(title = "blahblahblah", x = "dododod", y = "lalalala") +
  theme_b99()
...
theme_minimal() +
  theme(#text = element_text(family = "Univers", color = "#F9FEFF"),
        # axis.text = element_text(size = 12, color = "#F9FEFF"),
        # plot.background = element_rect(color = NA, fill = "#0053CD"),
        # panel.background = element_rect(color = NA, fill = "#0053CD"),
...
cols <- c("1" = "#FCF40E", "2" = "#3A3533", 
          "3" = "#6CA9C3", "4" = "#0F0E0E", "5" = "#175E78")
# yellow: #FCF40E
# dark grey: #3A3533
# light teal: #6CA9C3
# black: #0F0E0E
