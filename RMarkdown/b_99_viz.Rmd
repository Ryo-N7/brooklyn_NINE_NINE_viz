...
# find score-appearances difference


```{r}
ep_rating_df %>% 
  filter(title %in% c("The Negotiation", "The Fugitive, Part 1", "The Fugitive, Part 2",
                      "The Cruise", "The Pontiac Bandit Returns", "Pontiac Bandit")) %>% 
...
```{r}
ep_rating_df %>% 
  filter(title %in% c("Gray Star Mutual", "Kicks", "The Bank Job", "Mr. Santiago",
                      "Monster in the Closet", "Paranoia", "Terry Kitties", 
                      "Cheddar", "Adrian Pimento")) %>% 
  summarize(avg = mean(rating),
            med = median(rating))
```
