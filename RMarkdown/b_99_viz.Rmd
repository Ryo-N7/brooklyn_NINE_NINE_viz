...
I can combine the best of both worlds and put the bee swarm points on top of the box plots!
...
ep_rating_df %>% 
  ...
  ggbeeswarm::geom_beeswarm(color = "#FCF40E", cex = 2, size = 2) +
...
Pretty much the same M.O. as what I did to get the episode ratings here. One thing of note was using regex to get rid of the footnotes, I had to be extra careful to double escape the square brackets.
...
a little intermission here as I wanted to talk about this cool package i recently found on Twitter called "tidylogs"
